    ...
    createTabHandle(tabInfo){
        ...
        this.tabHandle[id] = {
            ...
            showIndex: (index: number) => {
                ...
                tabIndexDisplay = $('<div class="spork_jumpIndex">' + index + '</div>');
            ...
            /** Selected class */
            addSelectedClass: () => {
                tab.addClass('spork_selected');
            },
            removeSelectedClass: () => {
                tab.removeClass('spork_selected');
            },
        }
    }
